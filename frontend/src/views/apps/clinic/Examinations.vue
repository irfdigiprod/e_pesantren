<template>
  <div class="p-6">
    ...
    >
      <div>
        <h1 class="text-xl font-semibold text-slate-800">Pemeriksaan</h1>
        <p class="text-sm text-slate-500">
          Kelola catatan pemeriksaan kesehatan santri.
        </p>
      </div>
      <button
        @click="openCreate"
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
      <table class="min-w-full table-auto">
        ...
        <tbody class="text-sm text-slate-700">
          <tr v-for="(e, idx) in examinations" :key="e.id" class="border-t">
      ...
      >
        <div class="p-4 border-b flex justify-between">
          <h3 class="font-medium">
            {{ modal.mode === "create" ? "Tambah" : "Edit" }} Pemeriksaan
          </h3>
        ...
        <div class="p-4 space-y-3">
          <div class="grid grid-cols-2 gap-3">
            ...
            <div class="col-span-2">
              <label class="text-xs text-slate-500">Keluhan</label
              ><textarea
            ...
            <div class="col-span-2">
              <label class="text-xs text-slate-500">Penanganan/Treatment</label
              ><textarea
